...
Make sure to also check out the <code>[db.search()](https://docs.novorender.com/legacy/docs/data-js-api/interfaces/DataJsAPI.ObjectDB#search)</code> documentation.
