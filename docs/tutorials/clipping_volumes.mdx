...
Let's add a few meters extra to observe the effets
...
When combining multiple such half spaces, we must determine whether to use the intersection or union of thes halfspace volumes.
...
A perhaps more useful volume is a slab, consisting of a top and bottom plane, but otherwise extending into infinty.
...
We currently sypport up to 6 planes, allowing you to define simple polyhedra of any size, rotation and position.
