...
Example show how to create a 2d view of the model and the PDF. placing two matching points on each will calculate the translation scale and roatation needed to place the pdf properly in model space

<PlaygroundComponent
  {...tutorials.PDFPlacement.pdf_placement}
></PlaygroundComponent>
