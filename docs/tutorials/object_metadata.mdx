...
Generally you will work with either [HierarcicalObjectReference](../webgl-api/interfaces/NovoRender.HierarcicalObjectReference) or the full [ObjectData](../webgl-api/interfaces/NovoRender.ObjectData) metadata set.
