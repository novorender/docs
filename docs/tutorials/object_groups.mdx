...
Although the [ObjectGroup interface](../data-js-api/interfaces/DataJsAPI.ObjectGroup) itself is not particularly noteworthy,
...
In this example we have predefined groups which are set up for each floor and created buttons to isolate objectGroups
