...
The result object can be drawn using the utility function `drawProduct()` as above but we have chosen to handle each part of the result separately to give more flexibility on style and colour.
...
<PlaygroundComponent {...tutorials.drawing2D.drawing2d}></PlaygroundComponent>
