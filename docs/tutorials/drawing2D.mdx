...
These functions that draws to the canvas is placed in the frontend code to make it easy for developers to change the style of 2d rawings to fit their own application.
