...
async function drawLine(
    ...
    const drawProd3 = point6 ? measureView?.draw.getDrawObjectFromPoints([point5 as ReadonlyVec3, point6], { angles: false, closed: false }) : measureView?.draw.getDrawObjectFromPoints([point5 as ReadonlyVec3], { angles: false, closed: false });
