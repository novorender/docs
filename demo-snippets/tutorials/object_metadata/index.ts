...
export const objectMetadata = {
    ...demo("object_metadata", "metadata_from_pick", fromPick, { hiddenAreas: [{ startLineNumber: 0, endLineNumber: 13 }, { startLineNumber: 65, endLineNumber: 166 }] }, 'Metadata from picking objects.'),
    ...demo("object_metadata", "metadata_from_search", fromSearch, { hiddenAreas: [{ startLineNumber: 0, endLineNumber: 13 }, { startLineNumber: 70, endLineNumber: 172 }] }, 'Metadata from search.'),
