...
export class ClippingDemoHost
    extends BaseDemoHost
    implements IDemoHost<Module>
{
    ...
    async init() {
        ...
        this.modifyRenderState({ output: { samplesMSAA: 2 } });
    }
    ...
    async updateModule(module: Module) {
        ...
        const stateChanges = {
            clipping: module.main(cx, cy, cz, this.view),
