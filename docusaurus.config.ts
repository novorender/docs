        ...
        metadata: [
            {
                name: "keywords",
                content:
                    "novorender, novorender docs, novorender documentation, novorender/api, novorender web api, webgl, webgl 2, novorender rest api docs, api docs",
            },
        ],
    ...
    plugins: [
        ...
        [
            ...
            /** @type {import('docusaurus-plugin-typedoc').PluginOptions} */
            {
                ...
                gitRevision: (() => {
                    return execSync("cd @novorender && git rev-parse HEAD")
                        .toString()
                        .trim();
                })(),
                plugin: [
        ...
        [
            ...
            /** @type {import('docusaurus-plugin-typedoc').PluginOptions} */
            {
                ...
                plugin: [
                    "typedoc-plugin-frontmatter",
                    "./type-definitions/typedoc-custom-root.mjs",
                ],
            },
        ],
        [
            "docusaurus-plugin-openapi-docs",
            {
                ...
                config: {
                    dataRestApiV2: {
                        specPath:
                            "https://data-v2.novorender.com/swagger/v2/swagger.json",
