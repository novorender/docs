...
<PlaygroundComponent {...snippets.gettingStarted["Camera state"]} />
...
<PlaygroundComponent {...snippets.gettingStarted["Controller params"]} />
...
<PlaygroundComponent {...snippets.gettingStarted["Controller properties"]} />
